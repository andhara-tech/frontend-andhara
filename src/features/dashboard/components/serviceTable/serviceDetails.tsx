...
export const ServiceDetails = () => {
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-4 xl:grid-cols-8 gap-5 w-full overflow-y-auto p-2">
      <div className={`col-span-1 lg:col-span-2 xl:col-span-2 border-t-4 ${borderColor} rounded shadow p-4`}>
        <div className="mb-4">
      ...
      <div className={`col-span-1 lg:col-span-2 xl:col-span-2 border-t-4 ${borderColor} rounded shadow`}>
      ...
      <div className={`col-span-1 lg:col-span-4 xl:col-span-4 border-t-4 ${borderColor} rounded shadow`}>
        <div className="p-2">
